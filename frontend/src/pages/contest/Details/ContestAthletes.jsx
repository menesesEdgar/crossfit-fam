...
const ContestAthletes = () => {
  const { categories } = useContestContext()
    ...
    <div className="flex h-full flex-col gap-3 p-3 antialiased">
      ...
      {isOpenModal && (
        <ModalFormikForm
          ...
          formFields={<AthleteFormFields editMode={editMode} athleteForm={true} contestCategories={categories}/>}
...
const ProtectedContestAthletes = withPermission(ContestAthletes, "view_contest");

export default ProtectedContestAthletes;
