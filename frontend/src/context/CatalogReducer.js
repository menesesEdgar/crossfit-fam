const CatalogReducer = (state, action) => {
  switch (action.type) {
    ...
    case "UPDATE_CONTEST": {
      ...
      console.log("all contest ", allContest)
      return {
        ...state,
        contest: action.payload,
        contests: allContest,
